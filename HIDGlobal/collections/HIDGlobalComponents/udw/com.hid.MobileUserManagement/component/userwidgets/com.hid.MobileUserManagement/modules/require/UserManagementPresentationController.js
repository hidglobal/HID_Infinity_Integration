define([`com/hid/MobileUserManagement/UserManagementBusinessController`], function(UserManagementBusinessController)  {
  var instance = null;
  var pollCounter = 2;
  ...
  UserManagementPresentationController.prototype.updateDeviceStatus = function(deviceId, status,correlationId, S_CB, F_CB){
  ...
  UserManagementPresentationController.prototype.deleteDevice = function(deviceId,correlationId, S_CB, F_CB){
    let params = {"deviceId" : deviceId , "correlationId": correlationId };
    UserManagementBusinessController.deleteDevice(params, S_CB, F_CB);
  };
  
  UserManagementPresentationController.prototype.unassignDevice = function(deviceId,status,owner,correlationId, S_CB, F_CB){
  ...
  UserManagementPresentationController.prototype.assignDevice = function(deviceId,status,owner,correlationId,S_CB, F_CB){
    let params = {"deviceId" : deviceId , "status" : status , "owner" : owner, "correlationId": correlationId };
    UserManagementBusinessController.assignUnassignDevice(params, S_CB, F_CB);
  };


  UserManagementPresentationController.prototype.updateFriendlyName = function(deviceId, newName,correlationId, S_CB, F_CB){

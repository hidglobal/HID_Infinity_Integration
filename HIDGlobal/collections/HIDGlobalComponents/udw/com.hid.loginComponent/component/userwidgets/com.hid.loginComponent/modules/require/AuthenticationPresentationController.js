define(['com/hid/loginComponent/AuthenticationBusinessController'], function(AuthenticationBusinessController)  {
  ...
  AuthenticationPresentationController.prototype.validatePassword = function(username, password, S_CB, F_CB,rmsLoad){
  ...
  AuthenticationPresentationController.prototype.updateRMSServiceEvent = function(authType , mfa_key, S_CB , F_CB){
    AuthenticationBusinessController.updateRMSServiceEvent(authType, mfa_key, S_CB , F_CB);
  };

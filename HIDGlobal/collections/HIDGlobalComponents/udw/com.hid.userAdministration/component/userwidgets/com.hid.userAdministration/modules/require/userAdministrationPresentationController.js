define([`com/hid/userAdministration/userAdministrationBusinessController`], function(userAdministrationBusinessController)  {
  ...
  userAdministrationPresentationController.prototype.resetFailureCount = function(userid,authType, S_CB, F_CB){
    let params = {"userid" : userid, "authType" : authType };
  ...
  userAdministrationPresentationController.prototype.enableDisableAuthenticator = function(active,authType,sts,userid,S_CB, F_CB){
    let params = {"active" : active, "authType": authType, "status": sts, "userId": userid};
